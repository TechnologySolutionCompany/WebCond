...
const apiModules = {
  ...
  '/api/admin/units/save': new URL('./api/admin/units/save.js', import.meta.url),
  '/api/admin/units/delete': new URL('./api/admin/units/delete.js', import.meta.url),
  '/api/platform/condominiums/list': new URL('./api/platform/condominiums/list.js', import.meta.url),
  '/api/platform/status': new URL('./api/platform/status.js', import.meta.url),
  '/api/platform/condominiums/export': new URL('./api/platform/condominiums/export.js', import.meta.url),
  '/api/platform/condominiums/import': new URL('./api/platform/condominiums/import.js', import.meta.url),
