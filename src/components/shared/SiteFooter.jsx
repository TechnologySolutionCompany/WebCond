...
export const COMPANY = {
  phoneLabel: '+55 (81) 99724-3724',
  whatsapp: 'https://wa.me/5581997243724',
      ...
      <div className="site-footer-grid">
        ...
        <div>
          ...
          <div className="site-footer-links">
            <a href={COMPANY.whatsapp} target="_blank" rel="noopener noreferrer">{COMPANY.phoneLabel}</a>
          ...
          <a className="site-footer-whatsapp" href={COMPANY.whatsapp} target="_blank" rel="noopener noreferrer">
            <WhatsAppIcon size={15} color="#0b1117" /> WhatsApp
          </a>
        </div>
      </div>

      <div className="site-footer-bottom">
        <span>© 2026 Technology Solution Company BR — Todos os direitos reservados.</span>
