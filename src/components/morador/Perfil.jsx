...
export default function MoradorPerfil() {
  ...
  // Moradores só podem editar telefone e whatsapp
      ...
      <div style={{ maxWidth: 600 }}>
        ...
        <div className="card" style={{ marginBottom: 20, borderColor: '#388bfd40' }}>
          <div style={{ display: 'flex', gap: 20, alignItems: 'center' }}>
            <div style={{
              ...
              fontSize: 26, fontWeight: 700, color: '#58a6ff', flexShrink: 0,
            }}>
              {initials}
            </div>
            <div>
        ...
        <div className="card" style={{ marginBottom: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <ProfileField icon={CreditCard} label="CPF" value={profile.cpf || '—'} />
            ...
            {editing ? (
              <>
                <div className="form-group">
                  ...
                  <input className="input" value={form.telefone} onChange={e => setForm(f => ({ ...f, telefone: e.target.value }))} placeholder="(81) 90000-0000" style={{ '--accent': '#58a6ff' }} />
                </div>
                <div className="form-group">
                  <label className="form-label">WhatsApp</label>
                  <input className="input" value={form.whatsapp} onChange={e => setForm(f => ({ ...f, whatsapp: e.target.value }))} placeholder="(81) 90000-0000" style={{ '--accent': '#58a6ff' }} />
                </div>
              </>
            ) : (
              <>
                <ProfileField icon={Phone} label="Telefone" value={profile.telefone || '—'} />
        ...
        <div className="card" style={{ marginTop: 20, borderColor: '#58a6ff30', background: 'rgba(88,166,255,0.03)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, fontSize: 13, color: '#8b949e' }}>
            ...
            <div>💰 <strong style={{ color: '#e6edf3' }}>Pix:</strong> Via Picpay (chave informada pelo síndico)</div>
            <div>📱 <strong style={{ color: '#e6edf3' }}>Comprovante:</strong> Enviar via WhatsApp ao síndico</div>
            <div>⚠️ <strong style={{ color: '#e6edf3' }}>Multa:</strong> Sistema de 3 advertências por atraso</div>
          </div>
        </div>
      </div>
    </div>
